...
const name = defaultSettings.title || "运营管理系统"; // 标题
...
module.exports = {
  ...
  outputDir: "dist/admin" + dateFortmat(new Date(), "yyyyMMddhhmmss"),
  ...
  devServer: {
    ...
    proxy: {
      ...
      [process.env.VUE_APP_BASE_API]: {
        ...
        target: "http://47.103.22.175:8088",
