<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="primary" icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['system:dict:export']">导出</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button type="warning" icon="el-icon-share" size="mini" @click="handleSync" v-hasPermi="['system:dict:sync']">同步</el-button>
            </el-col>
        </el-row>
