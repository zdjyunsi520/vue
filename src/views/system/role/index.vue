    ...
    <div class="app-container">
      ...
      <el-form-item>
        ...
        >
            ...
            <el-col :span="1.5">
                <el-button type="danger" icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete" v-hasPermi="['system:role:remove']">删除</el-button>
            </el-col>
            <!-- <el-col :span="1.5">
        <el-button
        ...
        <template slot-scope="scope">
          ...
          ></el-switch>
            ...
            <el-table-column label="所属站点" prop="deptName" />
    ...
    methods: {
        ...
        getRoleMenuTreeselect(roleId) {
            roleMenuTreeselect(roleId).then(response => {
                console.log("roleMenuTreeselect", response.data);
