<template>
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="primary" icon="el-icon-share" size="mini" @click="handleConfigSync" v-hasPermi="['system:config:sync']">同步</el-button>
            </el-col>
        </el-row>
        ...
        <el-dialog :title="title" :visible.sync="open" width="500px">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="参数键名" prop="configKey">
                    <el-input v-model="form.configKey" :disabled="form.configKey != null" placeholder="请输入参数键名" />
                </el-form-item>
