<template>
    <div class="app-container">
        ...
        ></el-date-picker>
            ...
            <el-form-item>
                <el-date-picker :editable="false" v-model="queryParams.beginTime" default-time="00:00:00" align="right" type="datetime" placeholder="选择起始日期"></el-date-picker>
            </el-form-item>
            <el-form-item>
            ...
            <el-form-item>
                <el-button v-hasPermi="['monitor:operlog:query']" type="primary" icon="el-icon-search" size="mini" @click="handleQuery">搜索</el-button>
        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="warning" icon="el-icon-download" size="mini" @click="handleExport" v-hasPermi="['monitor:operlog:export']">导出</el-button>
            </el-col>
        </el-row>
        ...
        <el-table v-loading="loading" :data="list" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作状态" align="center" prop="jsonResult" :show-overflow-tooltip="true">
                <template slot-scope="{row}">
                    {{JSON.parse(row.jsonResult).msg}}
                </template>
            </el-table-column>
    ...
    methods: {
        filterTime() {
            if (
                ...
                this.queryParams.beginTime.length != 19
            ) {
        ...
        handleDelete(row) {
            ...
            this.$confirm("是否确认删除这些数据项吗?", "警告", {
                confirmButtonText: "确定",
                cancelButtonText: "取消",
                type: "warning"
            })
                .then(function() {
                    return delOperlogMutiple(operIds);
                })
                .then(() => {
                    this.getList();
