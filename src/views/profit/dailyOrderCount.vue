a<template>
    <div class="app-container">
        ...
        <el-table border v-loading="listLoading" :data="postList">
            ...
            <el-table-column label="已完成淘宝浏览单数" align="center" prop="tbBrowseOrderQuantityFinish" />
            ...
            <el-table-column label="照妖镜次数" align="center" prop="mirrorTimes" />
...
<script>
import { dailyOrderCount as fetchList } from "@/api/profit/station";
