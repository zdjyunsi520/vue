<template>
  <el-form ref="form" :model="form" :rules="rules">
    ...
    <el-form-item label="商家ID" prop="merId">
      <el-input v-model="form.merId" autocomplete="off" placeholder=""></el-input>
    </el-form-item>
...
<script>
import { typeTransfer as recharge } from '@/api/frontRecharge/seller';
