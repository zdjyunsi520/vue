          ...
          <el-row>
            <el-col :span="11" :xs="24">
              <el-form-item label="用电单位" prop="sourcetenantId">
                <el-select v-model="form.sourcetenantId" placeholder="请选择用电单位">
            ...
            <el-col :span="24" :xs="24">
              <el-col :span="11" :xs="24">
                <el-form-item label="抢修单位" prop="repairtenantid">
                  <el-select v-model="form.repairtenantid" placeholder="" @change="changeTenant">
                    <el-option v-for="(item,index) in TenantIds" :key="index" :label="item.Name" :value="item.Id"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
            ...
            <el-col :span="11" :xs="24">
              <el-form-item label="联系电话" prop="chargepersonno">
                <el-input v-model="form.chargepersonno" placeholder="请输入负责人联系电话" />
              </el-form-item>
            </el-col>
            <el-col :span="11" :xs="24">
            ...
            <el-col :span="11" :xs="24">
              <el-form-item label="联系电话" prop="receivepersonno">
                <el-input v-model="form.receivepersonno" placeholder="请输入受理人联系电话" />
              </el-form-item>
            </el-col>
            <el-col :span="11" :xs="24">
            ...
            <el-col :span="11" :xs="24">
              <el-form-item label="工单编号" prop="detecterId">
                <el-input v-model="form.detecterId" disabled placeholder="" />
              </el-form-item>
            </el-col>
