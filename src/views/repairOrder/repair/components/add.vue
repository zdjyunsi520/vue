          ...
          <el-row>
            <el-col :span="11" :xs="24">
              <el-form-item label="用电单位" prop="SourceTenantId">
                <el-select v-model="form.SourceTenantId" placeholder="" :disabled="disabled" @change="getAddress">
...
import { getTrees, getTenantEmployees, getTenantInfo } from "@/api/org";
