<template>
    <div class="comheight comflexbox">
        ...
        <div class="bg-white containerbox " ref="containerbox">
            ...
            <el-table v-loading="listLoading" :summary-method="getSummaries" show-summary element-loading-text="Loading" class="middletable" :data="dataList" ref='table' :height="tableHeight" :row-class-name='totalstyle' @row-click='handleRowInfo' border>
    ...
    methods: {
        ...
        getSummaries() {
            ...
            if (this.dataList && this.dataList.length) {
                //获取统计的data数据
                data = this.dataList[this.dataList.length - 1];
            }
            //this.propTotal统计的数据对应的属性
            if (data) return ["统计", ...this.propTotal.map(v => data[v])];
            else return ["统计", ...this.propTotal.map(v => 0)];
        },
        /** 搜索按钮操作 */
        handleQuery() {
