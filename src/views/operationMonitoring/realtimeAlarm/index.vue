  ...
  <div class="app-container">
    ...
    <div class="bg-white containerbox" ref="containerbox">
      <el-table v-loading.fullscreen.lock="listLoading" element-loading-background="rgba(0, 0, 0, 0.4)" element-loading-text="Loading" :data="dataList" :height="tableHeight" border style='margin-top:20px'>
        ...
        <el-table-column label="告警等级" width="80" prop="Level" :formatter="levelformatter"></el-table-column>
        ...
        <el-table-column label="信号名" width="80" prop="Signal"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 监控
    handleMonitor(row) {
      const intervalId = row.AssetsId;
      this.$router.push({
        name: "/operationMonitoring/realtime/index",
        params: { intervalId }
      });
    },
    // 派单
