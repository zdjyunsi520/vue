<template>
    <!-- 充值信息填写 -->
    <el-dialog top="30px" width="800px" :title="title+'公告'" :visible.sync="dialogVisible" :modal-append-to-body="false" :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false" center :destroy-on-close="true">
        <el-form ref="form" :model="form" :rules="rules">
            <el-form-item label="选择分站">
                <el-select :disabled="user.deptId>1" v-model="form.deptId" clearable size="small">
            ...
            <el-form-item label="是否弹窗">
                <el-checkbox v-model="form.noticeType" :true-label="2" :false-label="1">弹窗</el-checkbox>
            </el-form-item>
            <el-form-item label="是否置顶">

                <el-checkbox v-model="form.isOverhead" :true-label="1" :false-label="0">置顶</el-checkbox>
            </el-form-item>
...
<script>
import { add, update } from "@/api/notice/seller";
...
export default {
    ...
    methods: {
        ...
        create() {
            ...
            this.form.deptId = this.user.deptId == 1 ? 0 : this.user.deptId;
        },
        handleOpen() {
