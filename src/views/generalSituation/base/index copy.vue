              ...
              <el-col :span="8" :xs="24">
                <div class="bg-white">
                  ...
                  <el-row :gutter="5" class="legendbox">
                    ...
                    <el-col :span="12" :xs="24">
                      <PieChart :piechartData='repairPiechartData' />
                    </el-col>
                  </el-row>
                </div>
              </el-col>
                ...
                <div class="bg-white">
                  ...
                  <el-row :gutter="10" class="legendbox">
                    ...
                    <el-col :span="16" :xs="24">
                      <PieChart :piechartData='patrolPiechartData' />
                    </el-col>
                  </el-row>
                </div>
              </el-col>
              <el-col :span="8" :xs="24">
                <div class="bg-white">
                  ...
                  <el-row :gutter="10" class="legendbox">
                    ...
                    <el-col :span="16" :xs="24">
                      <PieChart :piechartData='collectionPiechartData' />
                    </el-col>
                  </el-row>
                </div>
              </el-col>
            ...
            <el-row :gutter="20" style="margin-top:20px;">
              ...
              <el-col :span="8" :xs="24">
                <div class="bg-white">
                  ...
                  <BarChart ref='chart' :chartData='typechartData' />
                </div>
              </el-col>
            </el-row>
          </el-scrollbar>
...
export default {
  ...
  data() {
    return {
      ...
      lineChartData: lineChartData0[0],
      radioType: 0,
      loading: false,
      structureChartData: {},
      typeChartData: {},
  ...
  created() {
    this.getTree();
    this.structureChartData = Object.assign({}, structureChartData);
    this.typeChartData = Object.assign({}, typeChartData);
    this.collectionPieChartData = Object.assign({}, collectionPieChartData);
    this.patrolPieChartData = Object.assign({}, patrolPieChartData);
    this.repairPieChartData = Object.assign({}, repairPieChartData);
    console.log(11, this.typeChartData);
    this.$nextTick(() => {
  ...
  methods: {
    ...
    handleSetLineChartData(type) {
      this.lineChartData = lineChartData0[type];
    }
  }
};
</script>
