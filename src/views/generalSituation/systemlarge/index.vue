                ...
                <el-row class="boxheight4">
                    ...
                    <div class="warnlistinfo">
                        <el-row class="showdiv" v-if="waringTop">
                            ...
                            <el-col :span="5">
                                {{waringTop.TenantName}}
                            </el-col>
                            <el-col :span="5">
                                {{waringTop.AssetsName}}
                            </el-col>
                            <el-col :span="6">
                                {{waringTop.Description}}
                            </el-col>
                            <el-col :span="6">
                                {{waringTop.Time}}
                            </el-col>
                        ...
                        <el-carousel direction="vertical" indicator-position="none">
                            ...
                            <el-carousel-item v-for='(item,index) in waringlist' :key='index' v-if="index%2==0">
                                <el-row class="showdiv">
                                    <el-col :span="2">
                                        <span class="smicon">
                                            <img src="@/assets/image/ic_tips.png" />
                                        </span>
                                    </el-col>
                                    <el-col :span="5">
                                        {{item.TenantName}}
                                ...
                                <el-row class="showdiv" v-if="index+1<waringlist.length">
                                    <el-col :span="2">
                                        <span class="smicon">
                                            <img src="@/assets/image/ic_tips.png" />
                                        </span>
                                    ...
                                    <el-col :span="5">
                                        {{waringlist[index+1].TenantName}}
                                    </el-col>
                                    <el-col :span="5">
                                        {{waringlist[index+1].AssetsName}}
                                    </el-col>
                                    <el-col :span="6">
                                        {{waringlist[index+1].Description}}
                                    </el-col>
                                    <el-col :span="6">
                                        {{waringlist[index+1].Time}}
                                    </el-col>
                                </el-row>
                            </el-carousel-item>
                        </el-carousel>
...
export default {
    ...
    methods: {
        ...
        getWarnings() {
            getWarnings().then(r => {
                if (r.data) {
                    this.waringTop = r.data[0];
                    this.waringlist = r.data.slice(1, 11);
                } else {
                    this.waringTop = null;
                    this.waringlist = [];
                }
