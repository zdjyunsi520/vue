    ...
    <div class="search-box onlyform-box" style="padding-bottom: 150px;">
      ...
      <el-scrollbar class="marginright-fx">
        <el-form :model="form" ref="form" label-position="right" :rules="rules" label-width="80px" style='width:370px'>
          ...
          <el-form-item label="验收人" prop="Receiver" style="display:none">
            <el-input disabled="disabled" v-model="form.Receiver" placeholder="" />
          </el-form-item>
          <el-form-item label="验收时间" prop="ReceiveTime" style="display:none">
      ...
      <el-col :span="24" :xs="24" class="absolute-bottom">
        <div class="form-footer">
          <el-button type="primary" icon="el-icon-s-promotion" @click="handleSubmit" :loading="loading" v-if="form1.Status == 3&&!ReadOnly">发 送</el-button>
          <el-button type="primary" icon="el-icon-s-release"  @click="handleBack" :loading="loading" v-if="form1.Status == 3&&!ReadOnly">回 退</el-button>
