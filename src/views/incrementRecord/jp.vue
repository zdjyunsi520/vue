<template>
    <div class="app-container">
        ...
        <el-table border v-loading="listLoading" :data="postList">
            ...
            <el-table-column prop="expressName" label="快递类型">
                <template slot-scope="{row}">
                    {{row.expressName+"("+row.storeHouseName+")"}}
                </template>
            </el-table-column>
            <el-table-column prop="goodsName" label="商品名称" />
            <el-table-column prop="consigneeName" label="发货人">
                <template slot-scope="{row}">
                    <div>{{row.shipperName}}</div>
                    <div>{{row.shipperPhone}}</div>
                </template>
            </el-table-column>
            <el-table-column prop="consigneeName" label="收货人">
                <template slot-scope="{row}">
                    <div>{{row.receiverName}}{{row.receiverPhone}}</div>
                    <div>{{row.receiverProvince}}{{row.receiverCity}}{{row.receiverDistrict}}</div>
            ...
            <el-table-column prop="waybillNo" label="快递单号" />
            <el-table-column prop="mallOrderNo" label="三方单号" />
...
import { jpList as fetchList } from "@/api/incrementRecord";
