<template>
  <el-dialog width="500px" :title="title+'子类'" :visible.sync="dialogVisible" :modal-append-to-body="false" :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false" center>
        ...
        <el-col :span="24">
          <el-form-item label="父级分类" prop="parentkey">
            <el-select v-model="form.parentkey" clearable size="small">
              <el-option :key="item.key" :label="item.name" :value="item.key" v-for="item in dataList" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="24">
