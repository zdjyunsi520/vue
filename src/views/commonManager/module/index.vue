  ...
  <div class="app-container">
    <el-form :inline="true">
      <el-form-item>
        ...
        <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd">新增应用</el-button>
        <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAddClass" :disabled="addId==''">新增分类</el-button>
