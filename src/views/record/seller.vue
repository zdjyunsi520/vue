a<template>
    <div class="app-container">
        <el-form class="xl-query" :model="queryParams" ref="queryForm" :inline="true" label-width="120px">
            ...
            <el-form-item prop="postCode">
                <el-input placeholder="交易最小金额" v-model="queryParams.startingNumber" clearable size="small" @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item prop="postCode">
                <el-input placeholder="交易最大金额" v-model="queryParams.endNumber" clearable size="small" @keyup.enter.native="handleQuery" />
            </el-form-item>
            ...
            <el-form-item>
                <el-button :loading="loading" v-hasPermi="['system:mer:fund:export']" type="warning" icon="el-icon-download" size="mini" @click="handleExport">导出</el-button>
            </el-form-item>
        </el-form>

        <el-table border v-loading="loading" :data="postList">
            <!-- <el-table-column type="selection" width="55" align="center" /> -->
            <el-table-column label="手机号码" align="center" width="110px" prop="merAccount" />
            <el-table-column label="交易类型" align="center" width="80px" prop="transactionType" :formatter="filterMoney" />
            ...
            <el-table-column label="订单编号" align="center" width="160px" prop="orderId" />
...
<script>
import { fetchList, exportExcel } from "@/api/record/seller";
