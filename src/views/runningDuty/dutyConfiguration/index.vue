  ...
  <div class="app-container">
    <div class="search-box">
      <el-form :model="queryParams" ref="queryForm" :inline="true" class="xl-query" :rules="rules">
        <el-form-item label="值班班组" prop="username">
      ...
      <el-row class="table-btns">
        ...
        <el-dropdown @command="handleCommand">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item command="a">设置值班班组</el-dropdown-item>
            <el-dropdown-item command="b">设置班次</el-dropdown-item>
            <el-dropdown-item command="c">设置角色</el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </el-row>
