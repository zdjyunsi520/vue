<template>
    <el-dialog width="70%" :title="title+'交接班记录'" :visible.sync="dialogVisible" :modal-append-to-body="true" :close-on-click-modal="false" :close-on-press-escape="false" :show-close="true" center>
        <!-- 添加或编辑参数配置对话框 -->
...
export default {
    ...
    methods: {
        ...
        reset(data) {
            ...
            this.form.RecorderId = this.form.RecorderId
                ? this.form.RecorderId
                : "";
