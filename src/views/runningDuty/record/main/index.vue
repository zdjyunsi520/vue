                        ...
                        <div class="text item">
                            <el-form ref="form" :model="form" :rules="rules" :inline="true">
                                ...
                                <el-form-item class="cardbtns">
                                    <el-button type="primary" size="mini" @click="handleAccept">接班</el-button>
                    ...
                    <el-card class="box-card">
                        ...
                        <div class="text item">
                            <el-form ref="form" :model="form" :rules="rules" :inline="true">
                                ...
                                <el-form-item class="cardbtns">
                                    <el-button type="primary" size="mini" @click="handleAccept1">交班</el-button>
                                    <!-- <el-button type="primary" size="mini" plain>召回</el-button> -->
                                    <el-button type="info" size="mini" plain @click="reset1">重置</el-button>
                                </el-form-item>
                            </el-form>
                        </div>
                    </el-card>
