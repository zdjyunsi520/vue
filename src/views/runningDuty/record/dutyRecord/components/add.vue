<template>
  <el-dialog top="20px" width="500px" :title="title+'值班记事'" :visible.sync="dialogVisible" :modal-append-to-body="false" :close-on-click-modal="false" :close-on-press-escape="false" :show-close="true" center>
