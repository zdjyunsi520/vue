  ...
  <div class="comheight">
    ...
    <div class="bg-white containerbox comheight" ref="containerbox">
      <el-table v-loading="listLoading" :data="dataList" @selection-change="handleSelectionChange" border :height="height" @sort-change="handleSortChange">
        ...
        <el-table-column label="用电单位" align="center" prop="TenantName" />
        <el-table-column label="联系人" align="center" prop="ContactPerson" />
        <el-table-column label="联系电话" align="center" prop="PhoneNo" />
        <el-table-column label="记事类型" align="center" prop="Type" />
        <el-table-column label="记事内容" align="center" prop="RecordContent" />
        <el-table-column label="记事时间" align="center" prop="UpdateTime" />
        <el-table-column label="导入下一班" align="center" prop="IsSucceed" />
      </el-table>
